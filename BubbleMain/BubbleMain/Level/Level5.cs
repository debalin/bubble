...
namespace BubbleMain.Level
{
    ...
    public class Level5 : GameScene
    {
        ...
        private int BBLQTY, saved, totaltime, finished, redbubbles;
        private string timetaken, scoretext, bubblessaved, redkilledtext;
        ...
        public override void Initialize()
        {
            ...
            k = gunindex + 1;
            ((RedBubble)actors[10]).Bubbles = Bubbles;
        ...
        public override void Update(GameTime gameTime)
        {
            ...
            if (gameTime.TotalGameTime.TotalSeconds - starttime > bluestep && bluestep <= 12.5) //add blue bubbles
            {
                ...
                bluestep += 0.5f;
                ((RedBubble)actors[10]).index = index;
            }

            if (!((RedBubble)actors[10]).draw)
            {
                actors[10] = new RedBubble(game, redbubbleposition, bubblesize, redbubblevelocity, new Vector2(890, 650), new Vector2(10, 50), redbubblemass, redbubbleomega, true, false, hole, spike1, 2);
                ((RedBubble)actors[10]).Bubbles = Bubbles;
                ((RedBubble)actors[10]).index = index;
                redbubbles++;
                ((DrawText)actors[13]).ChangeText(("Red Bubbles Killed : " + redbubbles));
            }
